    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-r from-slate-900 to-slate-800 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Dónde Comprar</h1>
          <p className="text-xl text-gray-300">
            Encuentra nuestras sucursales y puntos de venta
          </p>
        </div>
      </section>
            ...
            {config.locations.map((location, idx) => (
              <div key={idx} className="bg-white rounded-lg shadow-lg p-8 border-l-4 border-blue-600">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    <p className="text-sm text-gray-600 font-semibold">Contacto</p>
                    <div className="space-y-2">
                      <p className="text-gray-900">📞 <a href={`tel:${location.phone}`} className="text-blue-600 hover:underline">{location.phone}</a></p>
                      <p className="text-gray-900">💬 <a href={`https://wa.me/${location.whatsapp}`} target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">WhatsApp</a></p>
                    </div>
                  </div>

                  <div>
                    <p className="text-sm text-gray-600 font-semibold mb-2">Servicios</p>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 w-full px-4 py-3 bg-green-500 text-white font-bold rounded-lg hover:bg-green-600 transition justify-center"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-700">
                  Estamos ubicados en una zona de fácil acceso. Disponemos de estacionamiento para nuestros clientes.
                </p>
              </div>
              <div>
                <h4 className="font-bold text-gray-900 mb-2">Atención al Cliente</h4>
                <p className="text-gray-700">
                  Nuestro equipo está disponible para asesorarte sobre la mejor solución según tus necesidades.
                </p>
              </div>
            </div>
          </div>
