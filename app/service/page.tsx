    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-r from-slate-900 to-slate-800 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Servicio Técnico</h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-700 mb-8">
              Por favor, realice el siguiente chequeo según el tipo de equipo. En muchas ocasiones, estos pasos pueden resolver el problema.
            </p>
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Solicitar Servicio Técnico</h2>
            
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
              <p className="text-yellow-800">
                <span className="font-bold">ℹ️ Nota importante:</span> Si el problema persiste después de realizar los chequeos anteriores, por favor contáctenos por WhatsApp o teléfono.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-green-500 text-white font-bold rounded-lg hover:bg-green-600 transition"
                  >
          ...
          <div className="bg-blue-50 rounded-lg p-8">
            ...
            <p className="text-gray-700 mb-4">
              Te recomendamos realizar mantenimiento preventivo periódico en tus equipos para garantizar su correcto funcionamiento y prolongar su vida útil.
            </p>
      ...
      <section className="bg-gradient-to-r from-red-600 to-red-700 text-white py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">¿Tu problema requiere atención inmediata?</h2>
