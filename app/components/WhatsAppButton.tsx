...
export function WhatsAppButton({
  ...
  const handleClick = () => {
    ...
    alert(`✅ ${product.name} añadido a tu consulta.\n\nIr a "Mi Consulta" para revisar o enviar por WhatsApp.`);
  };
  ...
  const variantClasses = {
    primary:
      "bg-green-500 hover:bg-green-600 text-white font-bold rounded-lg transition",
    secondary:
  ...
  return (
    <button
      ...
      } ${sizeClasses[size]} ${!product.available ? "opacity-50 cursor-not-allowed" : ""}`}
    >
