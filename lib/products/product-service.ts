...
export function getProductsByCategory(category: ProductCategory): Product[] {
    return repository.getProductsByCategory?.(category) ?? getProducts().filter((product) => product.category === category);
}

export function getProductsByBrand(brand: ProductBrand): Product[] {
    return repository.getProductsByBrand?.(brand) ?? getProducts().filter((product) => product.brand === brand);
}
