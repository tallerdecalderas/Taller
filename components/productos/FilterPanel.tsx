        ...
        <div className="space-y-4 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm md:p-5">
          <div className="rounded-xl bg-slate-50 p-3 ring-1 ring-slate-200 md:p-3.5">
            <label
              ...
              className="mb-2 block text-xs font-semibold tracking-[0.08em] text-slate-500 uppercase"
            >
              Categoría
            </label>
            <select
              ...
              className="h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-800 transition outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
            >
